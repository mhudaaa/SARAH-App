...
<body class="dashboard">
	...
	<div id="slide-out" class="side-nav">
  	...
  	<div id="wrapper-d" class="wow fadeIn">
  		...
  		<form method="post" class="form-tambah" action="{{ url('/dash/jadwal/add') }}">

			{{ csrf_field() }}
            <div class="row mini">
                <div class="input-field col s5">
                    <label for="air">Suhu Atas</label>
                </div>
                <div class="input-field col s6">
                    <input id="air" type="number" name="jumlah_air">
                </div>
                <div class="input-field col s1">
                    <label for="air">&#176;C</label>
                </div>
            </div>
            <div class="row mini">
                <div class="input-field col s5">
                    <label for="air">Suhu Bawah</label>
                </div>
                <div class="input-field col s6">
                    <input id="air" type="number" name="jumlah_air">
                </div>
            ...
            <div class="row mini">
  				<div class="input-field col s12">
                    <label class="text-tosca bold">Pakan Pagi</label><br>
                </div>
            </div>
            <div class="row mini">
                <div class="input-field col s5">
  				...
  				<div class="input-field col s7">
	  				<select id="jenis_pakan" name="jenis_pakan" class="required" required="">
                        <option value="">- Pakan -</option>
                        <option value="1">Rumput Gajah</option>
                        <option value="2">Rumput Jepang</option>
                    </select>
  				</div>
  			</div>
            <div class="row mini">
                ...
                <div class="input-field col s5">
                    <input id="Jumlah" type="number" name="jumlah_pakan">
                </div>
            ...
            <div class="row mini">
                <div class="input-field col s12">
                    <label class="text-tosca bold">Pakan Siang</label><br>
                </div>
            </div>
            <div class="row mini">
                <div class="input-field col s5">
